              ...
              <Row className="justify-content-center">
                <Col xl={8}>
                  <div>
                    ...
                    <Row>
                      {data?.data?.map(post => {
                        const minutes = Math.floor((post.duration % 3600) / 60)
                        const seconds = Math.round(post.duration % 60)
                        const resultedDuration = `${minutes} мин, ${seconds} секунд`
                        return (
